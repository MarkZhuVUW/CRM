...
namespace CRM.Api.Context
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            new Customer { Id = customerIds[0], Name = "John Doe", Email = "john@example.com", PhoneNumber = "1234567890", Status = "Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[1], Name = "Jane Smith", Email = "jane@example.com", PhoneNumber = "0987654321", Status = "Lead", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[2], Name = "Bob Johnson", Email = "bob@example.com", PhoneNumber = "1112223333", Status = "Non-Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[3], Name = "Alice Williams", Email = "alice@example.com", PhoneNumber = "4445556666", Status = "Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[4], Name = "Charlie Brown", Email = "charlie@example.com", PhoneNumber = "7778889999", Status = "Lead", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[5], Name = "David Miller", Email = "david@example.com", PhoneNumber = "1231231234", Status = "Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[6], Name = "Emma Davis", Email = "emma@example.com", PhoneNumber = "4564564567", Status = "Non-Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[7], Name = "Frank Wilson", Email = "frank@example.com", PhoneNumber = "7897897890", Status = "Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[8], Name = "Grace Lee", Email = "grace@example.com", PhoneNumber = "2342342345", Status = "Lead", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[9], Name = "Henry Thomas", Email = "henry@example.com", PhoneNumber = "5675675678", Status = "Non-Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[10], Name = "Isabella Moore", Email = "isabella@example.com", PhoneNumber = "8908908901", Status = "Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[11], Name = "Jack Taylor", Email = "jack@example.com", PhoneNumber = "1231234567", Status = "Lead", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[12], Name = "Liam Anderson", Email = "liam@example.com", PhoneNumber = "9876543210", Status = "Non-Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[13], Name = "Mia Thomas", Email = "mia@example.com", PhoneNumber = "6543210987", Status = "Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[14], Name = "Noah Garcia", Email = "noah@example.com", PhoneNumber = "3456789012", Status = "Lead", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[15], Name = "Olivia Martinez", Email = "olivia@example.com", PhoneNumber = "4567890123", Status = "Non-Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[16], Name = "Sophia Hernandez", Email = "sophia@example.com", PhoneNumber = "5678901234", Status = "Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[17], Name = "Lucas Lopez", Email = "lucas@example.com", PhoneNumber = "6789012345", Status = "Lead", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[18], Name = "Ethan Walker", Email = "ethan@example.com", PhoneNumber = "7890123456", Status = "Non-Active", CreatedAt = DateTime.Now },
            new Customer { Id = customerIds[19], Name = "Ava Hall", Email = "ava@example.com", PhoneNumber = "8901234567", Status = "Active", CreatedAt = DateTime.Now },
        });
